...
const Page: NextPage<PageProps> = (_) => {
  ...
  return (
    <div className="w-screen transition-colors h-screen flex items-center gap-4 justify-center flex-col rx-bg-mauve-1">
      ...
      <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div className="text-center">
          <h1 className="tracking-tight font-extrabold rx-text-olive-11">
            <span className="block text-4xl sm:text-5xl md:text-6xl xl:inline rx-text-olive-11">
              Tailwind + Radix Colors
            </span>{" "}
          </h1>
          <p className="rx-bg-mauve-1 rx-text-mauve-12 p-4">ciao</p>
          <p className="mt-3 max-w-md mx-auto text-base rx-text-olive-11 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            {/* Describe the package */}
            <code>tailwind-radix-colors</code> is a{" "}
            <a target={"_blank"} href="https://tailwindcss.com">
              TailwindCSS
            </a>{" "}
            plugin that adds{" "}
            <a target={"_blank"} href="https://radix-ui.com/colors">
              Radix colors
            </a>{" "}
            to Tailwind. It also provides dynamic utilities for dark-colors.
          </p>
          <div className="mt-5 max-w-md mx-auto grid grid-cols-2 gap-4 md:mt-8">
            <Button
              ...
              color="olive"
              onClick={() =>
                router.push("https://github.com/rawnly/tailwind-radix-colors")
              }
            ...
            <Button
              ...
              color="lime"
              onClick={() =>
                router.push("https://npmjs.com/tailwind-radix-colors")
              }
      ...
      <span className="fixed bottom-5 left-1/2 -translate-x-1/2 rx-text-olive-11">
        Made with a ⌨ by <a href="https://fedevitale.dev">Federico Vitale</a>
      </span>
    </div>
  );
};
